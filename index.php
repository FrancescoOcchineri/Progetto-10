...
<div class="container mt-5 text-center">
    ...
    <div id="allBooksCarousel" class="carousel slide mx-auto" data-bs-ride="carousel" data-bs-interval="5000"
            ...
            for ($i = 0; $i < $num_rows; $i++) {
                ...
                for ($j = 0; $j < $items_per_row; $j++) {
                    ...
                    if ($index < $num_all_books) {
                        ...
                        echo '<img src="' . $book['img'] . '" class="card-img-top" alt="' . $book['titolo'] . '" style="height: 25rem;">'; // Imposta dimensioni fisse e centra l'immagine
                        echo '<div class="card-body">';
                        echo '<h4 class="card-title">' . $book['titolo'] . '</h4>';
                        echo '<p class="card-text fw-bold">' . $book['autore'] . '</p>';
                        echo '<span class="badge text-bg-dark">' . $book['genere'] . '</span>';
                        echo '<p class="card-text text-muted" style="font-size: 15px; line-height: 3rem;">Published in ' . $book['anno'] . '</p>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    }
